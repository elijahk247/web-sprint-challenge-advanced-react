// stretch: adding a test to shopping cart 
...
test("displays plants in cart", () => {
  // arrange: pass in the sample plants as props and create the shopping cart page
  const container = render(<ShoppingCart cart={samplePlants} />)

  // act 
  const plantContainer = screen.getByTestId = (/testName/i);
